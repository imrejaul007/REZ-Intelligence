/**
 * REZ Inventory Intelligence - RABTUL Integration
 */
...
export const inventoryIntelligenceRABTUL = { verifyToken, notifyMerchant };
export default inventoryIntelligenceRABTUL;
