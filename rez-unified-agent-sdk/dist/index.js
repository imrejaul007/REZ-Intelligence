...
var CircuitBreaker__default = /*#__PURE__*/_interopDefault(CircuitBreaker);
var EventEmitter__default = /*#__PURE__*/_interopDefault(EventEmitter);

// src/config/index.ts
var CircuitBreakerOptionsSchema = zod.z.object({
  timeout: zod.z.number().positive().default(5e3),
  errorThresholdPercentage: zod.z.number().min(0).max(100).default(50),
  resetTimeout: zod.z.number().positive().default(3e4),
  volumeThreshold: zod.z.number().int().positive().default(10)
});
var RetryOptionsSchema = zod.z.object({
  maxAttempts: zod.z.number().int().positive().default(3),
  initialDelay: zod.z.number().positive().default(100),
  maxDelay: zod.z.number().positive().default(5e3),
  factor: zod.z.number().positive().default(2),
  jitter: zod.z.boolean().default(true)
});
var SDKConfigSchema = zod.z.object({
  agentId: zod.z.string().min(1),
  internalTokens: zod.z.record(zod.z.string()),
  services: zod.z.object({
    paymentService: zod.z.string().url().optional(),
    walletService: zod.z.string().url().optional(),
    orderService: zod.z.string().url().optional(),
    bookingService: zod.z.string().url().optional(),
    notificationService: zod.z.string().url().optional(),
    analyticsService: zod.z.string().url().optional(),
    catalogService: zod.z.string().url().optional()
  }),
  circuitBreaker: CircuitBreakerOptionsSchema.optional(),
  retry: RetryOptionsSchema.optional(),
  timeout: zod.z.number().positive().default(3e4),
  logger: zod.z.custom().optional()
});
var PaymentMethodSchema = zod.z.enum([
  "upi",
  "card",
  "netbanking",
  "wallet",
...
var ProcessPaymentOptionsSchema = zod.z.object({
  currency: zod.z.string().length(3).default("INR"),
  customerEmail: zod.z.string().email().optional(),
  customerPhone: zod.z.string().optional(),
  description: zod.z.string().optional(),
  metadata: zod.z.record(zod.z.unknown()).optional()
});
var ProcessPaymentRequestSchema = zod.z.object({
...
zod.z.object({
  ...
  receiptUrl: zod.z.string().url().optional(),
  metadata: zod.z.record(zod.z.unknown()).optional()
});
var WalletTransactionTypeSchema = zod.z.enum([
  "credit",
  "debit",
  "refund",
  "cashback",
...
zod.z.object({
  ...
  currency: zod.z.string(),
  availableBalance: zod.z.number().int(),
  pendingBalance: zod.z.number().int(),
...
zod.z.object({
  ...
  currency: zod.z.string(),
  balance: zod.z.number().int(),
  status: zod.z.enum(["pending", "completed", "failed", "reversed"]),
  description: zod.z.string().optional(),
...
var OrderItemSchema = zod.z.object({
  ...
  price: zod.z.number().int().positive(),
...
var AddressSchema = zod.z.object({
  ...
  country: zod.z.string().default("IN"),
  phone: zod.z.string().optional()
});
var OrderStatusSchema = zod.z.enum([
  "created",
  "pending",
  "confirmed",
  "processing",
...
var CreateOrderRequestSchema = zod.z.object({
  items: zod.z.array(OrderItemSchema).min(1),
...
zod.z.object({
  ...
  subtotal: zod.z.number().int(),
  tax: zod.z.number().int(),
  shipping: zod.z.number().int(),
...
var BookingServiceTypeSchema = zod.z.enum([
  "hotel",
  "flight",
  "train",
  "bus",
...
var CreateBookingRequestSchema = zod.z.object({
  serviceType: BookingServiceTypeSchema,
  serviceId: zod.z.string().min(1),
  checkIn: zod.z.string().datetime().optional(),
  checkOut: zod.z.string().datetime().optional(),
  guestDetails: zod.z.object({
    name: zod.z.string(),
    email: zod.z.string().email().optional(),
    phone: zod.z.string().optional(),
    adults: zod.z.number().int().positive().default(1),
    children: zod.z.number().int().nonnegative().default(0)
  }).optional(),
  customerId: zod.z.string().min(1),
  paymentMethod: PaymentMethodSchema.optional(),
  metadata: zod.z.record(zod.z.unknown()).optional()
...
zod.z.object({
  ...
  checkIn: zod.z.string().datetime().optional(),
  checkOut: zod.z.string().datetime().optional(),
  confirmationCode: zod.z.string().optional(),
  totalAmount: zod.z.number().int(),
  currency: zod.z.string(),
  paymentId: zod.z.string().optional(),
  createdAt: zod.z.string().datetime(),
  updatedAt: zod.z.string().datetime(),
...
var NotificationChannelSchema = zod.z.enum([
  "email",
  "sms",
  "push",
  "whatsapp",
...
var NotificationTemplateSchema = zod.z.enum([
  "order_confirmation",
  "order_shipped",
  "order_delivered",
  "payment_success",
...
var SendNotificationRequestSchema = zod.z.object({
  userId: zod.z.string().min(1),
  template: NotificationTemplateSchema,
  channel: zod.z.union([NotificationChannelSchema, zod.z.array(NotificationChannelSchema)]).default("email"),
  data: zod.z.record(zod.z.unknown()),
  priority: zod.z.enum(["high", "normal", "low"]).default("normal"),
  scheduledAt: zod.z.string().datetime().optional(),
  metadata: zod.z.record(zod.z.unknown()).optional()
});
zod.z.object({
  notificationId: zod.z.string(),
  userId: zod.z.string(),
  template: NotificationTemplateSchema,
  channel: NotificationChannelSchema,
  status: zod.z.enum(["queued", "sent", "delivered", "failed"]),
  sentAt: zod.z.string().datetime().optional(),
  deliveredAt: zod.z.string().datetime().optional(),
  metadata: zod.z.record(zod.z.unknown()).optional()
});
var TrackEventRequestSchema = zod.z.object({
  event: zod.z.string().min(1),
  data: zod.z.record(zod.z.unknown()),
...
var ProductSearchFiltersSchema = zod.z.object({
  query: zod.z.string().optional(),
  category: zod.z.string().optional(),
  priceRange: zod.z.tuple([zod.z.number(), zod.z.number()]).optional(),
  rating: zod.z.number().min(0).max(5).optional(),
  inStock: zod.z.boolean().optional(),
  tags: zod.z.array(zod.z.string()).optional(),
  sortBy: zod.z.enum(["price", "rating", "popularity", "newest"]).optional(),
...
var ProductSchema = zod.z.object({
  ...
  tags: zod.z.array(zod.z.string()).optional(),
  rating: zod.z.number().min(0).max(5).optional(),
  reviewCount: zod.z.number().int().nonnegative().optional(),
  inStock: zod.z.boolean(),
  availableQuantity: zod.z.number().int().optional(),
  metadata: zod.z.record(zod.z.unknown()).optional()
});
zod.z.object({
...
var ServiceHealthSchema = zod.z.object({
  status: zod.z.enum(["healthy", "degraded", "unhealthy", "unknown"]),
  latency: zod.z.number().nonnegative().optional(),
  lastChecked: zod.z.string().datetime(),
  error: zod.z.string().optional()
});
zod.z.object({
  overall: zod.z.enum(["healthy", "degraded", "unhealthy", "unknown"]),
  services: zod.z.record(ServiceHealthSchema),
  checkedAt: zod.z.string().datetime()
});
zod.z.object({
  type: zod.z.string().min(1),
  payload: zod.z.unknown(),
  timestamp: zod.z.string().datetime().default(() => (/* @__PURE__ */ new Date()).toISOString()),
  ...
  const transports = [
    new winston__default.default.transports.Console({
      format: winston__default.default.format.combine(
        ...
        winston__default.default.format.printf(({ timestamp, level, message, ...meta }) => {
...
var BaseConnector = class {
  ...
  constructor(serviceName, baseUrl, authToken, options = {}) {
    ...
    this.circuitBreaker = new CircuitBreaker__default.default(
...
exports.AGENT_EVENTS = AGENT_EVENTS;
exports.AnalyticsConnector = AnalyticsConnector;
exports.AuthenticationError = AuthenticationError;
exports.BOOKING_EVENTS = BOOKING_EVENTS;
exports.BaseConnector = BaseConnector;
exports.BookingConnector = BookingConnector;
exports.BookingServiceTypeSchema = BookingServiceTypeSchema;
exports.BookingStatusSchema = BookingStatusSchema;
exports.CatalogConnector = CatalogConnector;
exports.CircuitBreakerOptionsSchema = CircuitBreakerOptionsSchema;
exports.CircuitOpenError = CircuitOpenError;
exports.ConfigBuilder = ConfigBuilder;
exports.CreateBookingRequestSchema = CreateBookingRequestSchema;
exports.CreateOrderRequestSchema = CreateOrderRequestSchema;
exports.DEFAULT_CIRCUIT_BREAKER = DEFAULT_CIRCUIT_BREAKER;
exports.DEFAULT_RETRY = DEFAULT_RETRY;
exports.DEFAULT_SERVICE_ENDPOINTS = DEFAULT_SERVICE_ENDPOINTS;
exports.DEFAULT_TIMEOUT = DEFAULT_TIMEOUT;
exports.EventBus = EventBus;
exports.EventPublisher = EventPublisher;
exports.NOTIFICATION_EVENTS = NOTIFICATION_EVENTS;
exports.NotificationChannelSchema = NotificationChannelSchema;
exports.NotificationConnector = NotificationConnector;
exports.NotificationTemplateSchema = NotificationTemplateSchema;
exports.ORDER_EVENTS = ORDER_EVENTS;
...
exports.ProcessPaymentRequestSchema = ProcessPaymentRequestSchema;
exports.ProductSearchFiltersSchema = ProductSearchFiltersSchema;
exports.RetryExhaustedError = RetryExhaustedError;
exports.RetryOptionsSchema = RetryOptionsSchema;
exports.SDKConfigSchema = SDKConfigSchema;
exports.SDKError = SDKError;
exports.SendNotificationRequestSchema = SendNotificationRequestSchema;
exports.ServiceError = ServiceError;
exports.TimeoutError = TimeoutError;
exports.TrackEventRequestSchema = TrackEventRequestSchema;
exports.UnifiedAgentSDK = UnifiedAgentSDK;
exports.ValidationError = ValidationError;
exports.WalletConnector = WalletConnector;
exports.WalletTransactionTypeSchema = WalletTransactionTypeSchema;
exports.createAnalyticsConnector = createAnalyticsConnector;
exports.createBookingConnector = createBookingConnector;
exports.createCatalogConnector = createCatalogConnector;
exports.createConfig = createConfig;
exports.createDefaultLogger = createDefaultLogger;
exports.createEventBus = createEventBus;
exports.createEventPublisher = createEventPublisher;
exports.createNotificationConnector = createNotificationConnector;
exports.createOrderConnector = createOrderConnector;
exports.createPaymentConnector = createPaymentConnector;
exports.createSDK = createSDK;
exports.createWalletConnector = createWalletConnector;
exports.loadInternalTokens = loadInternalTokens;
