...
exports.FLAVOR_PROFILES = exports.PAIRING_GUIDE = exports.INGREDIENT_CATEGORIES = exports.MAJOR_ALLERGENS = exports.DIETARY_TAGS = exports.CUISINES = void 0;
exports.matchCuisine = matchCuisine;
exports.matchDietaryTag = matchDietaryTag;
exports.containsAllergen = containsAllergen;
 ...
 */
function matchCuisine(input) {
    const normalizedInput = input.toLowerCase().trim();
    for (const cuisine of Object.values(exports.CUISINES)) {
 ...
 */
function matchDietaryTag(input) {
    const normalizedInput = input.toLowerCase().trim();
    for (const tag of Object.values(exports.DIETARY_TAGS)) {
 ...
 */
function containsAllergen(text) {
    const normalizedText = text.toLowerCase();
    const found = [];
    for (const allergen of Object.values(exports.MAJOR_ALLERGENS)) {
...
function getIngredientsByCategory(category) {
    const cat = exports.INGREDIENT_CATEGORIES[category];
