/**
 * REZ Attribution Loyalty Bridge - RABTUL Integration
 */
...
export const attributionLoyaltyBridgeRABTUL = { verifyToken, addCoins };
export default attributionLoyaltyBridgeRABTUL;
