...
export const rateLimits = {
  standard: createRateLimiter({ windowMs: 60000, max: 100 }),
  strict: createRateLimiter({ windowMs: 60000, max: 30 }),
  relaxed: createRateLimiter({ windowMs: 60000, max: 500 }),
  auth: createRateLimiter({ windowMs: 900000, max: 10 }),
  internal: createRateLimiter({ windowMs: 60000, max: 200 }),
