/**
 * REZ Real Time Decision Engine - RABTUL Integration
 */
...
export const realTimeDecisionEngineRABTUL = { verifyToken, getWallet };
export default realTimeDecisionEngineRABTUL;
