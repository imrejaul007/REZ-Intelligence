/**
 * REZ Staff Scheduling Service - RABTUL Integration
 */
...
export const staffSchedulingServiceRABTUL = { verifyToken, notifyUser };
export default staffSchedulingServiceRABTUL;
