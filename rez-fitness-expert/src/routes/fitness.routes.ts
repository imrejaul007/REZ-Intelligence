...
router.post('/query', validateRequest(fitnessQuerySchema), async (req: Request, res: Response, next: NextFunction) => {
  try {
...
router.post('/workout-plan', validateRequest(workoutPlanSchema), async (req: Request, res: Response, next: NextFunction) => {
  try {
...
router.post('/exercises', validateRequest(exerciseQuerySchema), async (req: Request, res: Response, next: NextFunction) => {
  try {
...
router.post('/progress', validateRequest(progressQuerySchema), async (req: Request, res: Response, next: NextFunction) => {
  try {
...
router.post('/recommendations', validateRequest(recommendationQuerySchema), async (req: Request, res: Response, next: NextFunction) => {
  try {
    const { userProfile } = req.body;
...
router.get('/workout-types', async (req: Request, res: Response) => {
...
router.get('/fitness-levels', async (req: Request, res: Response) => {
...
function getWorkoutTypeDescription(type: WorkoutType): string {
...
function getFitnessLevelDescription(level: FitnessLevel): string {
...
function getEquipmentDescription(eq: Equipment): string {
  const descriptions: Record<Equipment, string> = {
