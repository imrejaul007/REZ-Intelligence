...
export const FITNESS_INTENT_PATTERNS: IntentPattern[] = [
  {
...
export function detectFitnessIntent(query: string): FitnessIntent | null {
...
export function buildContextFromQuery(query: string, context: FitnessContext): FitnessContext {
  const lowerQuery = query.toLowerCase();
