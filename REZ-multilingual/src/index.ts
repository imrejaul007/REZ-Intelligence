...
const MONGODB_URI = process.env.MONGODB_URI || 'mongodb://localhost:27017/multilingual';
...
async function startServer(): Promise<void> {
  try {
    ...
    app.listen(PORT, () => {
      logger.info(`REZ Multilingual running on port ${PORT}`);
    });
