/**
 * REZ Notification Router - RABTUL Integration
 */
...
export async function sendSMS(phone: string, message: string) {
  try { await axios.post(`${NOTIFY}/api/notifications/sms`, { phone, message }, { headers: { 'X-Internal-Token': TOKEN } }); return { success: true }; }
  catch { return { success: false }; }
}
...
export const notificationRouterRABTUL = { verifyToken, sendPush, sendSMS, sendWhatsApp };
export default notificationRouterRABTUL;
