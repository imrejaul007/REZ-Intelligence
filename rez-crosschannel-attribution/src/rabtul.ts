/**
 * REZ Crosschannel Attribution - RABTUL Integration
 */
...
export const crosschannelAttributionRABTUL = { verifyToken, addCoins };
export default crosschannelAttributionRABTUL;
